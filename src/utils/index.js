...
// Asynchronous init function initializes the app
const init = async () => {
    await createManager();

    //While the team is not complete, the manager will be asked which type of employees the want to add
    ...
    //The employees array is passed into the generate html function & then this markdown is used to create a new team-profile.html
...
const createManager = async () => {
    ...
    //The manager answers will be generated form the manager's input to the questions
